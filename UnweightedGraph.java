...
public class UnweightedGraph<V> implements Graph<V> {
    ...
    public SearchTree dfsNonRecurs(int v) {
        ...
        while (!stack.isEmpty()) {
            ...
            int x = stack.peek();
            // Get neighbors list for x
            List<Edge> edges = neighbors.get(x);
            if (edges.size() == 0) {
